        ...
        <table>
          <thead>
            <tr>
              ...
              <th>
                <Sort label="بالانس بەدۆلار" attribute="name" />
              </th>
              <th>
                <Sort label=" بالانس بەدینار" attribute="usd_total_sales_balance" />
              </th>
          ...
          <tbody>
            <tr v-for="company in company.data" :key="company.id">
              ...
              <td data-label=" بالانس دۆلار  ">
                {{ formatPrice(company.usd_balance) }}
              </td>

              <td data-label="بالانس دینار ">
                {{ formatPrice(company.iqd_balance) }}
              </td>
